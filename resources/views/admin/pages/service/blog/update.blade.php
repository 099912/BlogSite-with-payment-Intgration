...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Update Blog Feature</h4>
        </div>

    </div>
    <form action="{{route('service.blog.update',$data->id)}}" method="POST" enctype="multipart/form-data">
       @csrf
    ...
    <div class="form-group row">
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                <img src="{{asset('/featureblog_image/'.$data->image)}}" width="80px" alt="">

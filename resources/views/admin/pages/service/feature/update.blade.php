...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Update Service Feature</h4>
        </div>

    </div>
    <form action="{{route('service.feature.update',$data->id)}}" method="POST" enctype="multipart/form-data">
       @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-10">
            <input class="form-control" placeholder="Discription" value="{{$data->discription}}" type="text" name="discription">
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                <img src="{{asset('/feature_image/'.$data->image)}}" width="80px" alt="">

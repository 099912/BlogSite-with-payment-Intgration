...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Update Memories</h4>
        </div>

    </div>
    <form action="{{route('home.memories.update',$data->id)}}" method="POST" enctype="multipart/form-data">
       @csrf
    ...
    <div class="form-group row">
        ...
        <div class="form-group">
            ...
            <div class="custom-file">
                ...
                <img src="{{asset('/memoriesimage/'.$data->image)}}" width="80px" alt="">

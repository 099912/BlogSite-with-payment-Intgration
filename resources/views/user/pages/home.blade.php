...
@foreach($headers as $header)
    <div class="img-bg rellax">
        <img src="{{asset('headerimage/' . $header->image)}}" alt="Image" class="img-fluid">
    </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-start">
            <div class="col-lg-5">
                ...
                <h1 class="heading" data-aos="fade-up">{{$header->title}}</h1>
                <p class="mb-5" data-aos="fade-up">{{$header->discription}}</p>
        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-4 order-lg-1">
                ...
                <div>
                    ...
                    <p data-aos="fade-up" data-aos-delay="200">{!!$explore->discription!!}</p>
    ...
    <div class="destination-slider-wrap">
        <div class="destination-slider">
            ...
            <div class="destination">
                <div class="thumb">
                    <img src="{{asset('travelimage/' . $travel->image)}}" alt="Image" class="img-fluid">
                    <div class="price">{{$travel->price}}</div>
                </div>
                <div class="mt-4">
                    <h3><a href="#">{{$travel->title}}</a></h3>
                    <span class="meta">{{$travel->location}}</span>
                </div>
            </div>
@endforeach
            {{-- <div class="destination">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 mb-4 mb-lg-0 order-lg-2" data-aos="fade-up">
                <img src="{{asset('memoriesimage/' . $memory->image)}}" alt="Image" class="img-fluid">
            </div>
            <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
                <h2 class="heading mb-4">{{$memory->title}}</h2>
                <p>{!!$memory->discription!!}</p>
        ...
        <div class="wide-slider-testimonial">
            ...
            <div class="item">
                ...
                <blockquote class="block-testimonial">
                    <div class="author">
                        <img src="{{asset('testimonialimage/' . $testimonial->image)}}" alt="Free template by TemplateUX">
                        <h3>{{$testimonial->name}}</h3>
                        <p class="position mb-5">{{$testimonial->profession}}</p>
                    </div>
                    <p>
                        <div class="quote">&ldquo;</div>
                         {!! Str::limit($testimonial->discription,300)!!}</p>
                </blockquote>
            </div>
@endforeach
            {{-- <div class="item">
